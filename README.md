...
This is the code repository for our paper:  [LoopLLM: Transferable Energy-Latency Attacks in LLMs via Repetitive Generation](https://arxiv.org/abs/2511.07876)
...
```bash
conda create -n loopllm python=3.12
conda activate loopllm
...
## 📝 Acknowledgements
This respository is mainly based on [GCG](https://github.com/llm-attacks/llm-attacks). Thanks for their wonderful works!